...
async function main() {
  ...
  if (!Array.isArray(candidate) || candidate.length !== 358) {
    throw new Error(`Refusing deployment: expected 358 nodes, got ${Array.isArray(candidate) ? candidate.length : 'invalid JSON'}`);
  }
