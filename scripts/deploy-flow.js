...
async function main() {
  ...
  if (!Array.isArray(candidate) || candidate.length !== 361) {
    throw new Error(`Refusing deployment: expected 361 nodes, got ${Array.isArray(candidate) ? candidate.length : 'invalid JSON'}`);
  }
